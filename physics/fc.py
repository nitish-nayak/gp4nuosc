...
current_params = get_grid_params(index, GRID_SIZE, contour_vars, fc_type)
...
for i in range(N_MC):
    ...
    profile_params = get_profile_params(profile_vars, fc_type)
    ...
    try:
        global_fit = fitter_global.Fit(mock_data, osc_seed, nuis_seed, False)
        ...
        profile_fit = fitter_profile.Fit(mock_data, osc_seed, nuis_seed, False)
